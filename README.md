# Thanks For Amazing `Oh My ZSH`

this repository for custom my oh my zsh, if you want same like me :
...
- set my alias
- set path when i'am use
- add zsh-autosuggestions
- add yarn lib for get yarn version info
